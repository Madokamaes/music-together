...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/40 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground shadow-[0_12px_32px_rgb(227_183_108/18%)] hover:bg-[#f3d79e]',
        destructive: 'bg-destructive/70 text-white hover:bg-destructive focus-visible:ring-destructive/20',
        outline: 'border border-border bg-white/5 shadow-xs hover:border-primary/35 hover:bg-primary/10 hover:text-primary',
        secondary: 'border border-border bg-white/[0.07] text-secondary-foreground hover:border-primary/25 hover:bg-primary/10 hover:text-primary',
